...
class MixinInfo implements Comparable<MixinInfo>, IMixinInfo
{
    ...
    protected List<ClassInfo> readTargetClasses(final MixinClassNode classNode, final boolean suppressPlugin) {
        ...
        if (publicTargets != null) {
            this.readTargets(targets, (Collection<String>)Lists.transform(publicTargets, (Function<? super Type, ?>)new Function<Type, String>() {
                @Override
        ...
        if (privateTargets != null) {
            this.readTargets(targets, (Collection<String>)Lists.transform(privateTargets, (Function<? super String, ?>)new Function<String, String>() {
                @Override
